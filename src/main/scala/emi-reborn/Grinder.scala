...
class EmiGrinderRecipe[R <: RebornRecipe](recipe: R) extends AbstractMachineRecipe[R](recipe, EmiGrinderRecipe.CATEGORY) {
  ...
  override def addWidgets(widgets: WidgetHolder): Unit = 
    ...
    widgets.add(SlotWidget(getInput(0), 55, 36))
    widgets.add(SlotWidget(getOutput(0), 55 + 46, 36 - 9 - 18).recipeContext(this))
    widgets.add(SlotWidget(getOutput(1), 55 + 46, 36 - 9).recipeContext(this))
    widgets.add(SlotWidget(getOutput(2), 55 + 46, 36 - 9 + 18).recipeContext(this))
    widgets.add(SlotWidget(getOutput(3), 55 + 46, 36 - 9 + 36).recipeContext(this))
